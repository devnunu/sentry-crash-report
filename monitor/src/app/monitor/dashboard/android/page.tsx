              ...
              <Group justify="space-between" align="center">
                <div>
                  ...
                  <Text size="xl" fw={700} c="green.6">
                    {androidPlatform.crashFreeRate}%
                  </Text>
                </div>
                <RingProgress
                  size={60}
                  thickness={6}
                  sections={[{ value: androidPlatform.crashFreeRate, color: 'green' }]}
                />
              </Group>
            </Card>
          </Grid.Col>
              ...
              <Group justify="space-between" align="center">
                <div>
                  ...
                  <Text size="xl" fw={700} c="red.6">
                    {androidPlatform.criticalIssues}개
                  </Text>
                </div>
                ...
                <div>
                  ...
                  <Group gap={4}>
                    <Text size="xl" fw={700} c="violet.6">
                      {formatNumber(androidPlatform.affectedUsers)}명
                    </Text>
                    {getTrendIcon(androidPlatform.trend, 20)}
                  </Group>
                </div>
              ...
              <Group justify="space-between" align="center">
                <div>
                  ...
                  <Text size="xl" fw={700} c="blue.6">
                    {formatNumber(androidPlatform.totalEvents)}건
                  </Text>
                </div>

...
def create_sample_data():
    ...
    try:
        ...
        print("✅ 샘플 데이터 생성 완료")
        print("   - 집중 모니터링 단계: sample-intensive-1.0.0")
        print("   - 일반 모니터링 단계: sample-normal-0.9.0")
        return True
    except Exception as e:
...
def run_full_test_suite():
    ...
    tests = [
        ...
        ("신규 릴리즈 테스트", lambda: test_new_release("full-test-1.0.0")),
        ("정리 테스트", test_cleanup),
    ]
...
def main():
    ...
    parser.add_argument('--scenario', 
                       ...
                       default='validate', 
                       help='테스트 시나리오')
    parser.add_argument('--version', help='테스트할 릴리즈 버전')
